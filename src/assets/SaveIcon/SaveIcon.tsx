...
//Icon Link: https://www.svgrepo.com/svg/522264/save-floppy
const SaveIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="save-icon"
      viewBox="0 0 32 32"
      width={width}
      height={height}
      className={className}
    ...
    >
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Icon-Set" transform="translate(-152.000000, -515.000000)" fill={iconColor}>
