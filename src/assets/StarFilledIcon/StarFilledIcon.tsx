...
//Icon Link: https://www.svgrepo.com/svg/535661/star
const StarFilledIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  return (
    <BaseIconSvg
      baseClassName="star-filled-icon"
      viewBox="0 0 16 16"
      width={width}
      height={height}
      className={className}
