...
//Icon Link: https://www.svgrepo.com/svg/532719/star-sharp-half
const HalfStarIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  return (
    <BaseIconSvg
      baseClassName="half-star-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
