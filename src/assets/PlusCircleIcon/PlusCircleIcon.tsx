...
//Icon Link: https://www.svgrepo.com/svg/522230/plus-circle
const PlusCircleIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="plus-circle-icon"
      viewBox="0 0 32 32"
      width={width}
      height={height}
      className={className}
    ...
    >
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Icon-Set" transform="translate(-464.000000, -1087.000000)" fill={iconColor}>
