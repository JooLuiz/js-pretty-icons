...
//Icon Link: https://www.svgrepo.com/svg/521608/document
const DocumentIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="document-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
