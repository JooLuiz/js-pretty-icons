...
//Icon Link: https://www.svgrepo.com/svg/532512/play-pause
const PlayPauseIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="play-pause-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
