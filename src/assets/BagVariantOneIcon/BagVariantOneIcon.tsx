...
//Icon Link: https://www.svgrepo.com/svg/529371/bag
const BagVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  return (
    <BaseIconSvg
      baseClassName="bag-variant-1-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
