...
//Icon Link: https://www.svgrepo.com/svg/521692/google-drive
const GoogleDriveIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="google-drive-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
