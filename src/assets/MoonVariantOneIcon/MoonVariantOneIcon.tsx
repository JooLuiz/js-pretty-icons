...
//Icon Link: https://www.svgrepo.com/svg/521764/moon
const MoonVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="moon-variant-1-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
