...
//Icon Link: https://www.svgrepo.com/svg/532574/image-minus
const ImageMinusIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="image-minus-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
