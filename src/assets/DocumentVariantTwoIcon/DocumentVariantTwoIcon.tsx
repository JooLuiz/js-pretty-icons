...
//Icon Link: https://www.svgrepo.com/svg/509890/document
const DocumentVariantTwoIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="document-variant-2-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
