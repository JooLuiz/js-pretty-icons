...
//Icon Link: https://www.svgrepo.com/svg/509794/chat-bubble-exclaimation
const ChatExclamationIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="chat-exclamation-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
