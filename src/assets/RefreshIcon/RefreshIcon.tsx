...
//Icon Link: https://www.svgrepo.com/svg/522438/refresh
const RefreshIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="refresh-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
    ...
    >
      ...
      <path d="M20.4716 2.42157V8.07843H14.8147" stroke={iconColor} strokeLinecap="round" strokeLinejoin="round"/>
    </BaseIconSvg>
  );
};
