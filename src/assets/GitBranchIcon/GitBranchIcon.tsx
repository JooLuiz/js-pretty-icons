...
//Icon Link: https://www.svgrepo.com/svg/507314/git-branch
const GitBranchIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="git-branch-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
