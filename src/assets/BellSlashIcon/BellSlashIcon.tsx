...
//Icon Link: https://www.svgrepo.com/svg/532095/bell-slash
const BellSlashIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="bell-slash-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
