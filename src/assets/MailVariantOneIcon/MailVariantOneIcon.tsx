...
//Icon Link: https://www.svgrepo.com/svg/522169/mail
const MailVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="mail-variant-1-icon"
      viewBox="0 -4 32 32"
      width={width}
      height={height}
      className={className}
    ...
    >
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g id="Icon-Set" transform="translate(-412.000000, -259.000000)" fill={iconColor}>
