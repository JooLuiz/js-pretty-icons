...
//Icon Link: https://www.svgrepo.com/svg/532577/image-square-xmark
const ImageCloseIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="image-close-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
