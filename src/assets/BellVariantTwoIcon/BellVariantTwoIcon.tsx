...
//Icon Link: https://www.svgrepo.com/svg/521999/bell
const BellVariantTwoIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="bell-variant-2-icon"
      viewBox="0 0 30 30"
      width={width}
      height={height}
      className={className}
