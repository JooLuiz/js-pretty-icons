...
//Icon Link: https://www.svgrepo.com/svg/369328/gitlab
const GitlabVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="gitlab-variant-1-icon"
      viewBox="0 0 15 15"
      width={width}
      height={height}
      className={className}
