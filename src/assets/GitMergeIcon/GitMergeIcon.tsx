...
//Icon Link: https://www.svgrepo.com/svg/509962/git-merge
const GitMergeIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="git-merge-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
