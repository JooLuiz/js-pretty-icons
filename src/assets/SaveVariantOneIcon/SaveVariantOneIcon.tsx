...
//Icon Link: https://www.svgrepo.com/svg/509215/save-alt
const SaveVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconFill = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="save-variant-1-icon"
      viewBox="0 0 32 32"
      width={width}
      height={height}
      className={className}
