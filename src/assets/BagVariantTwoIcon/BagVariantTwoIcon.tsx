...
//Icon Link: https://www.svgrepo.com/svg/529444/cart-2
const BagVariantTwoIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  return (
    <BaseIconSvg
      baseClassName="bag-variant-2-icon"
      viewBox="0 0 24 24"
      width={width}
      height={height}
      className={className}
