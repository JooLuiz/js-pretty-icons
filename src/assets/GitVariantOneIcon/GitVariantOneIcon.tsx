...
//Icon Link: https://www.svgrepo.com/svg/473619/git
const GitVariantOneIcon = ({ width, height, color, className, ariaLabel, title }: IconProps) => {
  const iconColor = color ? color : "#000000";

  return (
    <BaseIconSvg
      baseClassName="git-variant-1-icon"
      viewBox="0 0 32 32"
      width={width}
      height={height}
      className={className}
